...
<div id="SchedulesForBusStops" class="buttonEffectGroup buttonMenu DivTable">
<?php
foreach ( $stop_schedule as $key_shape => $value_shape ):
    $HeadsignDisplay = _trim_headsign( $value_shape["Headsign"] );
?>
    <div class="DivTableRow" >
        <div class="buttonEffectItem buttonEffectHeader DivTableCell" >
            <?=$HeadsignDisplay?>
        </div>
    </div>
<?php
...
?>
    <div class="DivTableRow" >
        <div
            class="buttonEffectItem buttonMenuItem DivTableCell <?=$ArrivingSoonClass?>"
            data-shapeID="<?=$key_shape?>"
            data-schedule="ArrivingSoon<?=$key_shape?>"
        >
            Arriving Soon
        </div>
        <div id="ArrivingSoonTimes<?=$key_shape?>" class="buttonEffectSpacer DivTableCell">
            <div class="buttonFlyoutRight buttonEffectRoundedAll">
<?php
...
?>
                <div
                    ...
                    class="buttonMenuItem TimeSelectListener <?=$ThisClassVisibility?>"
...
?>
    <div class="DivTableRow" >
        <div class="buttonEffectItem buttonMenuItem HeadsignListListener DivTableCell" data-shapeID="<?=$key_shape?>" data-schedule="Weekday<?=$key_shape?>" >
            Weekday Schedule
        </div>
        <div id="WeekdayTimes<?=$key_shape?>" class="buttonEffectSpacer DivTableCell"></div>
    </div>
<?php
    endif;
...
?>
    <div class="DivTableRow" >
        <div class="buttonEffectItem buttonMenuItem HeadsignListListener DivTableCell" data-shapeID="<?=$key_shape?>" data-schedule="Saturday<?=$key_shape?>" >
            Saturday Schedule
        </div>
        <div id="SaturdayTimes<?=$key_shape?>" class="buttonEffectSpacer DivTableCell"></div>
    </div>
<?php
    endif;
...
?>
    <div class="DivTableRow" >
        <div class="buttonEffectItem buttonMenuItem HeadsignListListener DivTableCell" data-shapeID="<?=$key_shape?>" data-schedule="Sunday<?=$key_shape?>" >
            Sunday Schedule
        </div>
        <div id="SundayTimes<?=$key_shape?>" class="buttonEffectSpacer DivTableCell"></div>
    </div>
<?php
    endif;
endforeach;
